...
Current best: **AUROC 0.6909** (AutoGluon-style greedy ensemble: 2xCatBoost + XGBoost + ExtraTrees with per-fold weight optimization, diagnosis pattern + discharge grouping + categorical interactions, no numeric interactions).
...
|---|---|---|---|---|
| **Our best** | **2xCB + XGB + ET** | **0.6909** | **5-fold stratified CV** | **encounter-level splits, fixed seed** |
