...
Current best: **AUROC 0.6902** (2xCatBoost + XGBoost ensemble with diagnosis pattern + discharge grouping + categorical interaction features).
...
|---|---|---|---|---|
| **Our best** | **2xCatBoost + XGBoost** | **0.6902** | **5-fold stratified CV** | **encounter-level splits, fixed seed** |
