...
Current best: **AUROC 0.6906** (2xCatBoost + XGBoost ensemble with diagnosis pattern + discharge grouping + categorical interactions, no numeric interactions).
...
|---|---|---|---|---|
| **Our best** | **2xCatBoost + XGBoost** | **0.6906** | **5-fold stratified CV** | **encounter-level splits, fixed seed** |
