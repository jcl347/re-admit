...
Current best: **AUROC 0.6896** (CatBoost with Langevin boosting + XGBoost ensemble, 0.75/0.25 blend).
...
|---|---|---|---|---|
| **Our best** | **CatBoost + XGBoost** | **0.6896** | **5-fold stratified CV** | **encounter-level splits, fixed seed** |
